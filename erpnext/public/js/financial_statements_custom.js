frappe.provide("erpnext.financial_statements_custom");
...
erpnext.financial_statements_custom= {
	...
	formatter: function (value, row, column, data, default_formatter, filter) {
		...
		if (data && column.fieldname == "account") {
			...
			if (data.account) {
				column.link_onclick =
					"erpnext.financial_statements_custom_custom.open_general_ledger(" + JSON.stringify(data) + ")";
			}
			column.is_tree = true;
		}
	...
	onload: function (report) {
		...
		erpnext.financial_statements_custom.filters = get_filters();
